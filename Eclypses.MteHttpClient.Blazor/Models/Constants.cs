namespace MteHttpClient.Models
{
    public class Constants
    {
        ...
        /// </summary>
        internal static string RELAY_SERVER_ID_HEADER = "x-mte-relay-server-id";
        /// <summary>
        /// x-mte-relay-client-id
        /// </summary>
        internal static string RELAY_CLIENT_ID_HEADER = "x-mte-relay-client-id";
        /// <summary>
        /// x-mte-relay-eh
        /// </summary>
        internal static string RELAY_ENCODED_HEADERS_HEADER = "x-mte-relay-eh";
        /// <summary>
        /// x-mte-relay-pair-id
        /// </summary>
        public static string RELAY_PAIR_ID_HEADER = "x-mte-relay-pair-id";
        /// <summary>
        /// Authorization
        /// </summary>
        ...
        /// </summary>
        public static string NUGET_CONTENT_ROOT = "./_content/Eclypses.MteHttpClient.Blazor";
        /// <summary>
        ...
        private static void LoadRelayErrors()
        {
            ...
            RelayErrors.Add(567, "PairID Header (or sessionID) is required, but not found.");
        }
    }
}
