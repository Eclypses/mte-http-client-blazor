...
namespace MteHttpClient.Models
{
    ...
    public class MteRelayEndpoint
    {
        ...
        /// </summary>
        public string? RelayIdentifier { get; set; }
        /// <summary>
        ...
        /// <summary>
        /// A list of special headers that the Mte-Relay requires.
        /// </summary>
        public ConcurrentDictionary<string, string> MteRelaySpecialHeaders = new ConcurrentDictionary<string, string>();
        /// <summary>
