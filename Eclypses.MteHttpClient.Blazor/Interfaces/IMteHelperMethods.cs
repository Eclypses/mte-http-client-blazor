...
namespace MteHttpClient.Interfaces
{
    ...
    public interface IMteHelperMethods
    {
        ...
        void PutTheEncoderAsync(IJSObjectReference encoder);
        ...
        /// <summary>
        /// Initializes the Secure Data Repository for storing MteStates
        /// </summary>
        /// <returns></returns>
        Task InitializeSDRAsync();
        ...
        Task<string> RetrieveFromSDRAsync(string name, bool persistent = false);
        ...
        Task StoreInSDRAsync(string name, string data, bool persistent = false);
        ...
        /// <param name="persistent">if set to <c>true</c> [persistent].</param>
        /// <returns>Completed task.</returns>
        Task RemoveFromSDRAsync(string name, bool persistent = false);
    }
}
